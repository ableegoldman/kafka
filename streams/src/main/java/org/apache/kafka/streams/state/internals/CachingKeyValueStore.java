...
public class CachingKeyValueStore
    ...
    private void initInternal(final ProcessorContext context) {
        ...
        cache.addDirtyEntryFlushListener(cacheName, entries ->
                putAndMaybeForward(entries, (InternalProcessorContext) context));
    }

    private void putAndMaybeForward(final List<ThreadCache.DirtyEntry> entries,
        ...
        if (flushListener != null) {
            for (final ThreadCache.DirtyEntry entry : entries) {
                ...
                if (rawNewValue != null || rawOldValue != null) {
                    ...
                    records.add(new KeyValue<>(entry.key(), entry.newValue()));
